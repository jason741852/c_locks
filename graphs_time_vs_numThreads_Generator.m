A = importdata('Time_data/mutex_lock_-t.txt');
B = importdata('Time_data/spin_lock_-t.txt');
C = importdata('Time_data/my_mutex_lock_-t.txt');
D = importdata('Time_data/my_spinTAS_lock_-t.txt');
E = importdata('Time_data/my_spinTTAS_lock_-t.txt');
F = importdata('Time_data/my_queue_lock_-t.txt');
