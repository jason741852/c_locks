A = importdata('Time_data/mutex_lock_-c.txt');
B = importdata('Time_data/spin_lock_-c.txt');
C = importdata('Time_data/my_mutex_lock_-c.txt');
D = importdata('Time_data/my_spinTAS_lock_-c.txt');
E = importdata('Time_data/my_spinTTAS_lock_-c.txt');
F = importdata('Time_data/my_queue_lock_-c.txt');
